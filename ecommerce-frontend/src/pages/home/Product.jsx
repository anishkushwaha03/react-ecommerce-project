...
export function Product({ product, loadCart, imageLoading = 'lazy' }) {
  ...
  return (
    <div
      className={`mx-auto w-full max-w-67.5 rounded-2xl border border-neutral-700 bg-neutral-50 p-0 shadow-[10px_10px_0px_0px_rgba(0,0,0,0.14)] transition-all duration-300 ease-out motion-reduce:transition-none ${isCardVisible ? 'translate-y-0 opacity-100' : 'translate-y-2 opacity-0'}`}
    >
